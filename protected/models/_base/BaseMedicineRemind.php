...
abstract class BaseMedicineRemind extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('id', 'required'),
			array('id, patient_id, sick_id, is_enabled, notify_hour_type, hour_interval, day_interval, dosage_unit, meal, last_updated', 'numerical', 'integerOnly'=>true),
			array('dosage', 'numerical'),
			array('name, notify_times_in_day, notify_days_in_week, start_date, end_date, more_instruction', 'safe'),
			array('patient_id, sick_id, name, is_enabled, notify_hour_type, notify_times_in_day, hour_interval, notify_days_in_week, start_date, end_date, day_interval, dosage, dosage_unit, meal, more_instruction, last_updated', 'default', 'setOnEmpty' => true, 'value' => null),
