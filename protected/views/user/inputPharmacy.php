            ...
            <div class="box-content">
                <form action="#" method="POST" class='form-horizontal form-validate' id="bb">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" name="contact_num" id="phone" class="input-xlarge" data-rule-email="true" data-rule-required="true">
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        $('#bb').submit(function (e) {
            ...
            $.ajax({
                ...
                url: '<?php echo Yii::app()->createUrl('user/addPharmacy') ?>',
                type: 'POST',
                data: data,
                dataType: 'json',
